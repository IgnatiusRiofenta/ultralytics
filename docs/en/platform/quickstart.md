...
| Model   | Size        | Speed    | Accuracy | Recommended GPU (all plans)                               |
| ------- | ----------- | -------- | -------- | --------------------------------------------------------- |
| YOLO26n | Nano        | Fastest  | Good     | RTX 4090 (24 GB) or RTX PRO 6000 (96 GB)                  |
...
| YOLO26x | Extra Large | Slowest  | Best     | H100 SXM (80 GB); H200 (141 GB) or B200 (180 GB) on Pro/Enterprise |
